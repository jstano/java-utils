...
public final class Numbers {
  ...
  private static final int RAW_HOURS_ROUND_PRECISION = 4;
  private static final int PERCENT_ROUND_PRECISION = 4;
  ...
  public static double roundPercent(double value) {
    return round(value, PERCENT_ROUND_PRECISION);
  }
  ...
  public static double roundRawHours(double value) {
    return round(value, RAW_HOURS_ROUND_PRECISION);
  }
  ...
  public static long truncateLong(double value) {
    return (int)value;
  }
